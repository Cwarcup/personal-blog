...
![css](https://media4.giphy.com/media/yYSSBtDgbbRzq/giphy.gif?cid=790b76114a5ae5e6f08d4129fba7e0666702a8cb58ef9c57&rid=giphy.gif&ct=g

Responsive web design (RWD) is an approach to web design that makes web pages render well on a variety of devices and window or screen sizes.

## Common CSS Patterns

Start your body off like so:
...
Targetting a specific element:

- target the element you want to target with the tag name first (e.g. `<h1>`) and then add the class (e.g. `.heading`)
...
Pixels are not always the best to use because it does **not scale well**.
...
The viewport is the user's visible area of a web page. It depends on the size of the device and the size of the browser/ user is using. The viewport is the area that the user is able to see. With the popularity of mobile devices, the viewport is becoming more and more important.
