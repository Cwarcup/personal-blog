...
draft: false
summary: First day of Web Developer Bootcamp at Lighthouse Labs. I learned how to use the command line interface (CLI) and how to use the Node.js framework.
---
