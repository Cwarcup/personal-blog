...
- Is just a way of naming the routes.
- Is a convention.
- represents the endpoints of the API.

| REST convention     | HTTP Method |
| ------------------- | ----------- |
| `/users`            | GET         |
| `/users/:id`        | GET         |
| `/users`            | POST        |
...
REST conventions can be extended! Let's say we want to get the commenrts for a video.

```
GET /videos/:id/comments
```

This is a GET request to the `/videos/:id/comments` endpoint.
