...
<div className="my-1 px-2 w-full">![nodes](/static/images/individualBlogPostImages/node.png)</div>- each
circle is a _node_ - nodes represent a key entity and contain data about the entity. - each connection
between nodes is called an _edge_
